...
base_path = "/Users/daniel/TU-Wien-DS/Thesis"
path_chest_imagenome = f"{base_path}/ImaGenome"
path_mimic_cxr = f"{base_path}/MIMIC-CXR"
path_mimic_cxr_jpg = f"{base_path}/MIMIC-CXR-JPG"
path_full_dataset = f"{base_path}/rgrg-dataset-with-reference-reports"
path_chexbert_weights = f"{base_path}/rgrg/src/CheXbert/src/models/chexbert.pth"
path_runs_object_detector = f"{base_path}/rgrg/runs/object_detector"
path_runs_full_model = f"{base_path}/rgrg/runs/full_model"
path_test_set_evaluation_scores_txt_files = f"{base_path}/rgrg/src"
